...
def EventDetails():
    ...
    cursor.execute(
        "CREATE TABLE IF NOT EXISTS event_details (event_name TEXT, event_id TEXT PRIMARY KEY, event_date TEXT, event_time TEXT, event_duration Text)")
...
def TicketDetails():
    ...
    cursor.execute(
        "CREATE TABLE IF NOT EXISTS ticket_details (customer_name TEXT, ticket_id TEXT PRIMARY KEY, event_name TEXT, event_id TEXT, event_date TEXT, event_time TEXT, duration Text)")
...
def BookTicket(customer_name, ticket_id, event_name):
    ...
    try:
        ...
        cursor = conn.cursor()
        cursor.execute(
            "INSERT INTO ticket_details (customer_name, ticket_id, event_name, event_id, event_date, event_time, duration) VALUES (?, ?, ?, ?, ?, ?, ?)",
...
def CreateNewEvent(event_name, event_id, event_date, event_time, event_duration):
    try:
        ...
        cursor = conn.cursor()
        cursor.execute(
            "INSERT INTO event_details (event_name, event_id, event_date, event_time, event_duration) VALUES (?, ?, ?, ?, ?)",
